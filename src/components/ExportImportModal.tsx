  ...
  const handleExportExcel = () => {
    const dataToExport = parts.map((part) => {
      ...
      return {
        ...
        'Order Date': part.orderDate || '',
        'Delivery Date': part.receiveDate || '',
      ...
      try {
        ...
        const mapped: Partial<BomPartItem>[] = rawData.map((row, index) => {
          ...
          return {
            ...
            orderDate: row['Order Date'] ? String(row['Order Date']).trim() : undefined,
            receiveDate: row['Delivery Date'] || row['Receive Date'] ? String(row['Delivery Date'] || row['Receive Date']).trim() : undefined,
